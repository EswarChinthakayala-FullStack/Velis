...
interface ClientDrawerFooterProps {
  mode: 'create' | 'edit';
  isSubmitting: boolean;
  onCancel: () => void;
}

export const ClientDrawerFooter: React.FC<ClientDrawerFooterProps> = ({
  mode,
  isSubmitting,
  onCancel,
}) => {
  return (
    <div className="px-6 py-4 border-t border-zinc-800 bg-[#0E0E10] flex items-center justify-end gap-2 shrink-0 select-none">
      <button
        type="button"
        onClick={onCancel}
...
export default ClientDrawerFooter;
